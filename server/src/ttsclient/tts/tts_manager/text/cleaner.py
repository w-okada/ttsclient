...
def clean_text(text, language, version=None):
    if version == "v1":
        raise NotImplementedError("v1 テキスト処理はサポートされていません")
    ...
    language_module = __import__("ttsclient.tts.tts_manager.text." + language_module_map[language], fromlist=[language_module_map[language]])
