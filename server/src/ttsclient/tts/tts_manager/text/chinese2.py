...
if is_g2pw:
    ...
    model_dir = f"{os.path.dirname(__file__)}/G2PWModel"
    g2pw = G2PWPinyin(model_dir=model_dir, model_source="modules/chinese-roberta-wwm-ext-large", v_to_u=False, neutral_tone_with_five=True)
